...
inst_list = ['',
...
for line in inst_list:
    for character in line:
        current_value = lut[current_value][character]
    out_string += str(current_value)

print out_string

new_lut = {1: {'U': 1, 'D': 3, 'L': 1, 'R': 1},
           2: {'U': 2, 'D': 6, 'L': 2, 'R': 3},
           3: {'U': 1, 'D': 7, 'L': 2, 'R': 4},
           4: {'U': 4, 'D': 8, 'L': 3, 'R': 4},
           5: {'U': 5, 'D': 5, 'L': 5, 'R': 6},
...
for line in inst_list:
    for character in line:
        current_value = new_lut[current_value][character]
    out_string += str(current_value)
